 ...
 * 
 * @version $Revision: 1.4 $ $Date: 2008/07/25 07:21:07 $
 */
public class TextParserTest extends TestCase
{
	...
	public void testParseHTMLstream( )
	{
		...
		Document doc = new TextParser( ).parse( getClass( )
		...
		res = "";
		child = child.getNextSibling( );
		for ( ; child != null && child.getNodeType( ) == Node.TEXT_NODE; child = child
				.getNextSibling( ) )
		{
			res += child.getNodeValue( );
		}
	...
	public void testParsePlainstream( )
	{
		...
		Document doc = new TextParser( ).parse( getClass( )
				.getResourceAsStream( "htmlparser_plain.txt" ), null );
		Element root = (Element) doc.getFirstChild( );
		Node child = root.getFirstChild( );
		String res = "";
		for ( ; child != null && child.getNodeType( ) == Node.TEXT_NODE; child = child
