 ...
 * </copyright>
 *
 * $Id: DesignValues.java,v 1.2 2010/11/29 06:31:33 rlu Exp $
 */
 ...
 * <em><b>Design Values</b></em>'. <!-- end-user-doc -->
 * 
...
public interface DesignValues extends EObject
{
	...
	/**
	 * Returns the value of the '<em><b>Data Set Parameters</b></em>'
	 ...
	 *        extendedMetaData="kind='element' name='DataSetParameters'"
	 * @generated
	 */
	 ...
	 * 
	 * @param value
	 *            the new value of the '<em>Data Set Parameters</em>'
	...
	/**
	 * Returns the value of the '<em><b>Result Sets</b></em>' containment
	 * reference. <!-- begin-user-doc --> <!-- end-user-doc --> <!--
	 * begin-model-doc --> A collection of result sets' definition and metadata.
	 * If the metadata can be derived, i.e. can be obtained by an ODA driver in
	 * each design session, an ODA host designer is not required to include the
	 * derived metadata in the next design session request. An ODA designer may
	 * ignore such metadata in a Request. <!-- end-model-doc -->
	 * 
	 ...
	 *        "kind='element' name='ResultSets' namespace='http://www.eclipse.org/datatools/connectivity/oda/design'"
	 * @generated
	 */
	 ...
	 * 
	 * @param value
	 *            the new value of the '<em>Result Sets</em>' containment
	 *            reference.
	 * @see #getResultSets()
	 * @generated
	 */
	...
	/**
	 * Returns the value of the '<em><b>Data Set Parameters1</b></em>'
	 * containment reference. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Data Set Parameters1</em>' containment
	 * reference isn't clear, there really should be more of a description
	 * here...
	 * </p>
	 * <!-- end-user-doc --> <!-- begin-model-doc --> A collection of top-level
	 * parameters defined for a data set. If the metadata can be derived, i.e.
	 * can be obtained by an ODA driver in each design session, an ODA host
	 * designer is not required to include the derived metadata in the next
	 ...
	 * @model containment="true" required="true" extendedMetaData=
	 *        "kind='element' name='DataSetParameters' namespace='http://www.eclipse.org/datatools/connectivity/oda/design'"
	 * @generated
	 */
	 ...
	 * Sets the value of the '
	 * {@link org.eclipse.birt.report.model.adapter.oda.model.DesignValues#getDataSetParameters1
	 * <em>Data Set Parameters1</em>}' containment reference. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Data Set Parameters1</em>'
	 *            containment reference.
	 * @see #getDataSetParameters1()
	 * @generated
	 */
	void setDataSetParameters1(
			org.eclipse.datatools.connectivity.oda.design.DataSetParameters value );
