 ...
 * </copyright>
 *
 * $Id: ModelValidator.java,v 1.4 2009/07/01 01:56:39 ywang1 Exp $
 */
...
public class ModelValidator extends EObjectValidator
{
			...
			DiagnosticChain diagnostics, Map<Object, Object> context )
	{
		switch ( classifierID )
		{
			...
			case ModelPackage.CHART_WITH_AXES :
				return validateChartWithAxes( (ChartWithAxes) value,
						diagnostics,
						context );
			case ModelPackage.CHART_WITHOUT_AXES :
				return validateChartWithoutAxes( (ChartWithoutAxes) value,
						diagnostics,
						context );
			case ModelPackage.DIAL_CHART :
				return validateDialChart( (DialChart) value,
						diagnostics,
						context );
			...
			case ModelPackage.COVERAGE_TYPE_OBJECT :
				return validateCoverageTypeObject( (Double) value,
						diagnostics,
						context );
			default :
				return true;
			...
			DiagnosticChain diagnostics, Map<Object, Object> context )
	{
		...
		if ( result || diagnostics != null )
			result &= validateCoverageType_Max( coverageType,
					diagnostics,
					context );
		return result;
	}
